...
import 'package:pkl_smkn1mejayan_guru/modules/views/absensi_bermasalah_page.dart';
...
class AppRoute{
  ...
  static const String absenTrouble = AbsenBermasalahPage.routeName;
  ...
  static Map<String, WidgetBuilder> routes={
    ...
    absenTrouble: (context) => AbsenBermasalahPage(),
  };
}