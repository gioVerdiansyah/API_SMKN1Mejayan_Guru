...
class ApiRoutes {
  ...
  static final Uri getAnggotaRoute = Uri.parse("${dotenv.get('API_URL')}/$guruId/anggota/get");
  static final Uri absenTroubleRoute = Uri.parse("${dotenv.get('API_URL')}/$guruId/absensi/trouble");
}
